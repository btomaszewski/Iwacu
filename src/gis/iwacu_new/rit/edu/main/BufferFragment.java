...
public class BufferFragment extends Fragment {
	...
	public void updateArticleView(int position) {
		...
		//http://resources.esri.com/help/9.3/arcgisengine/arcobjects/esriGeometry/bitmaps/GeomEnvProps.gif
		//bottom left to top right
		

		Double xmin = Double.parseDouble(getResources().getString((R.string.map_xmin)));
		Double ymin = Double.parseDouble(getResources().getString((R.string.map_ymin)));
		Double xmax = Double.parseDouble(getResources().getString((R.string.map_xmax)));
		Double ymax = Double.parseDouble(getResources().getString((R.string.map_ymax)));
		
		Envelope env = new Envelope(xmin, ymin,xmax, ymax);
		
		//Envelope env = new Envelope(-8139237.214629, 5016257.541842,-8090341.387563, 5077377.325675);
