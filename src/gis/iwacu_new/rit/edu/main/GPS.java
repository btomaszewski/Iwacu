...
public class GPS extends Activity
{
	...
	void initViews()
	{
		...
		String path = Environment.getExternalStorageDirectory() + "/" + getResources().getString((R.string.Iwacu_Directory)) + getResources().getString((R.string.offline_map_database_directory)) + getResources().getString((R.string.offline_map_database_name));
