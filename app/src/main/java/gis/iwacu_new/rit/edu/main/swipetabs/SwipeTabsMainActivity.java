 ...
 //   @Override
    ...
    public static class AppSectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public int getCount() {
        	...
        	//determine how many elements are in the learning content document
    ...
    public static class LaunchpadSectionFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            //go right to collection view, send the XML learning content
            Intent intent = new Intent(getActivity(), SwipeCollectionActivity.class);
