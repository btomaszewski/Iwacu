...
public class TrackAnalyzer {
    ...
    private static final String TAG = TrackAnalyzer.class.getName();
...
//		maxAltitude = 0d;
    ...
    public void analyze(boolean hasLog) {
        if (hasLog)
            Log.i(TAG, "Perform TrackAnalyzer");
        ...
        if (hasLog) {
            Log.i(TAG, "totalTime=" + MyTimeUtils.getTimeString(totalTime));
            Log.i(TAG, "totalDistance=" + totalDistance + "m");
            Log.i(TAG, "averageSpeed=" + averageSpeed + "km/hr");
            Log.i(TAG, "maximumSpeed=" + maximumSpeed + "km/hr");
            Log.i(TAG, "minAltitude=" + minAltitude + "m");
            Log.i(TAG, "maxAltitude=" + maxAltitude + "m");
            Log.i(TAG, "trackPoints=" + trackPoints);
        }
    }

    public void analyzeAndUpdate(long trackID) {
        Log.i(TAG, "trackName=" + trackName);
        Log.i(TAG, "trackDescription=" + trackDescription);
        Log.i(TAG, "trackStartGMTTime=" + startGMTTime);
        analyze(true);
        ...
        Log.i(TAG, "measureVersion has been updated: " + measureVersion);
    }
    ...
    public void analyzeAndSave() {
        ...
        Log.i(TAG, "insertTrack() finished");

        analyze(true);

        BigPlanet.DBAdapter.updateTrack(trackID, totalTime, totalDistance,
                averageSpeed, maximumSpeed, minAltitude, maxAltitude, trackPoints, measureVersion);
        Log.i(TAG, "Insert a new track successfully");
        Log.i(TAG, "-------------------------------");
    }
