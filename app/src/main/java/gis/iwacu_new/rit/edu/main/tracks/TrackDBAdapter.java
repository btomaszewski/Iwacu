package gis.iwacu_new.rit.edu.main.tracks;
...
/**
 * This class manages and SQLite database. It begins with a ton of string constants for managing
 * the database which I feel fairly certain can be refactored out or at least I hope they can.
 *
...
public class TrackDBAdapter {
    ...
    private static final String SQL_UPDATE_1_1 = "DROP TABLE IF EXISTS '" + TRACKS_TABLE + "_2';";
    private static final String SQL_UPDATE_1_2 = "CREATE TABLE '" + TRACKS_TABLE + "_2' AS SELECT * FROM '" + TRACKS_TABLE + "';";
    private static final String SQL_UPDATE_1_3 = "DROP TABLE '" + TRACKS_TABLE + "';";
    private static final String SQL_UPDATE_1_5 = "INSERT INTO '" + TRACKS_TABLE + "' (" +
            FIELD_trackid + ", " +
            FIELD_name + ", " +
            FIELD_description + ", " +
            FIELD_startTime + ", " +
            ...
            FIELD_trackSource + ", " +
            FIELD_measureVersion +
            " FROM '" + TRACKS_TABLE + "_2';";
    private static final String SQL_UPDATE_1_6 = "UPDATE '" + TRACKS_TABLE + "' SET " + FIELD_measureVersion + "=0;";
    private static final String SQL_UPDATE_1_7 = "DROP TABLE '" + TRACKS_TABLE + "_2';";
